...
- **[Omnigent: an open-source meta-harness over Claude Code, Codex, Cursor](meta-harness/2026-06-omnigent-an-open-source-meta-harness-over-claude-code-codex.md)** · composite **59.7** · Jun 2026  
