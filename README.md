...
- **[GigaWiper: modular destructive malware that fakes ransomware](product-security/malware-wipers/2026-07-gigawiper-modular-destructive-malware-that-fakes-ransomware.md)** · Product Security · Jul 9, 2026 · composite **64.3** · [source ↗](https://www.microsoft.com/en-us/security/blog/2026/07/09/gigawiper-anatomy-of-a-destructive-backdoor-assembled-from-multiple-malware/)  
