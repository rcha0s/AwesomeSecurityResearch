...
- **[Over 970,000 AI-Apps on model hubs measured: thousands leak credentials, some carry embedded backdoors](https://arxiv.org/abs/2606.30373)** · composite 56.1 · _flagged needs_review (low confidence / novelty / relevance)_
...
<sub>Generated by scripts/generate_review.py on 2026-07-21. 11 item(s) awaiting review.</sub>
