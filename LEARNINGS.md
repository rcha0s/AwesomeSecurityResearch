...
> Ranked, source-cited takeaways across Security and AI. Updated 2026-07-21.

## 📈 Ranked findings

### AsyncAPI npm compromise: import-time payload defeats --ignore-scripts · `72.12`
...
### Phantom Squatting: attackers register the domains LLMs hallucinate · `68.3`
...
### ToolHive MCP SSRF: host-side discovery runs outside the sandbox it enforces · `67.4`
...
### Better Models, Worse Tools: SOTA models regress on non-native tool schemas · `67.25`
...
### OpenClaw's ClawHub skill marketplace: an agentic supply-chain attack surface · `63.75`
...
### Goal-persistent agents: a frontier model built a bespoke zlib fuzzing lab in a day · `63.65`
...
### ShadowPickle: pickle-VM import tricks evade ten model scanners and four model hubs · `62.22`
...
### Agent skill security is a lifecycle problem, not just a runtime one (SkillSec-Eval) · `61.85`
...
### GigaWiper: modular destructive malware that fakes ransomware · `61.25`
...
### Kemp LoadMaster pre-auth RCE: uninitialized heap + missing null byte (CVE-2026-8037) · `58.35`
...
### Omnigent: an open-source meta-harness over Claude Code, Codex, Cursor · `57.6`
...
<sub>Generated by scripts/generate_skills.py on 2026-07-21.</sub>
