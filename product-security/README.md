...
_4 vetted findings · updated 2026-07-21 · ranked by composite · latest 31 days only · [3 held for review](../REVIEW.md)._
...
- **[AsyncAPI npm compromise: import-time payload defeats --ignore-scripts](supply-chain-dependencies/2026-07-asyncapi-npm-compromise-import-time-payload-defeats-ignore-s.md)** · composite **72.12** · Jul 16, 2026 · 🔗 +2 sources  
...
- **[Phantom Squatting: attackers register the domains LLMs hallucinate](supply-chain/2026-07-phantom-squatting-attackers-register-the-domains-llms-halluc.md)** · composite **68.3** · Jun 30, 2026  
...
- **[GigaWiper: modular destructive malware that fakes ransomware](malware-wipers/2026-07-gigawiper-modular-destructive-malware-that-fakes-ransomware.md)** · composite **61.25** · Jul 9, 2026  
...
- **[Kemp LoadMaster pre-auth RCE: uninitialized heap + missing null byte (CVE-2026-8037)](application-security/2026-06-kemp-loadmaster-pre-auth-rce-uninitialized-heap-missing-null.md)** · composite **58.35** · Jun 29, 2026  
