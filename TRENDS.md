...
> Rising themes per topic, clustered from tagged findings (live + recent archive). Updated 2026-07-16. A theme needs ≥2 findings from ≥2 sources; **recent activity is weighted highest**.
...
<sub>Generated by scripts/trends.py on 2026-07-16.</sub>
